...
private Map<String, TextView> fechasTVs;
    ...
    public void solicitarTemperaturas(){
        ...
        new JsonArrayRequest( Request.Method.GET,url_registros, null,new Response.Listener<JSONArray>(){
            @Override
    ...
    private void mostrarTemperaturas(JSONArray temperaturas){String registroId;
